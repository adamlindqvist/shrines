...
export class Hud {
    ...
    constructor(options: HudOptions, onRestart: () => void) {
        ...
        hud.id = 'hud';
        hud.innerHTML = `<section class="health"><div class="eyebrow"></div><div id="hearts"></div></section><section class="quest"><span class="sun">☀️</span><div><strong id="quest-title"></strong><p id="quest-copy"></p></div></section><div class="controls"><span><kbd>WASD</kbd> Move</span><b>·</b><span><kbd>SPACE</kbd> Attack</span></div><div id="toast"></div><div id="overlay" hidden><div class="end-card"><span class="end-icon">☀️</span><h1 id="end-title"></h1><p id="end-copy"></p><button id="restart">Play again <span>↗</span></button></div></div><output id="diagnostics" aria-hidden="true"></output>`;
