...
const GAME: AdventureConfig = {
    ...
    puzzle: {
        blocks: [{ symbol: 'sun', x: 1.5, z: 6.5 }],
        plates: [{ symbol: 'sun', x: 4, z: -5.2 }],
        chest: { x: 9.15, z: -5.4 },
...
/** Original scenery order is preserved to keep its seeded appearance stable. */
export const meadowArea: AdventureArea = {
    name: 'Mossy Meadow',
    seed: 73,
    island: ISLAND,
    game: GAME,
